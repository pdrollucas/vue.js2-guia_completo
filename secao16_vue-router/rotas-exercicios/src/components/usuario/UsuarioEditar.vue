<template>
    <div class="usuario-editar">
        ...
        <div id="rodape">
            <h3>Rodape navegavel por hash</h3>
        </div>
    </div>
</template>
...
<script>
    export default{
        ...
        beforeRouteLeave(to, from, next){ // só irá aceitar ir para outra página se o usuário clicar em confirmar ou ter a certeza que quer voltar
            if(this.confirmou){
                next()
            } else {
