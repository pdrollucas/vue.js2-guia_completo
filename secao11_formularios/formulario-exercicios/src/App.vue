		...
		<div class="conteudo">
			<form class="painel">
				...
				<Rotulo nome="E-mail">
					...
					<!-- Lazy serve para mandar o dado só quando o usuário tirar o foco do input -->
					<!-- Trim serve para remover os espaços de antes e depois do que o usuário digitou -->
				</Rotulo>
				<Rotulo nome="Senha">
				...
				<Rotulo nome="Idade">
					...
					<!-- .number serve para transformar o valor de string para numérico -->
				</Rotulo>
			...
			<div class="painel" v-if="enviado==true">
				...
				<Rotulo nome="Mensagem">
					...
					<!-- o "white-space: pre" serve para preservar os espaços em branco, incluindo quebras de linha -->
				</Rotulo>
				<Rotulo nome="Características do problema">
					<span>
						<ul>
